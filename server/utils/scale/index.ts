...
const Scales = { MCMI, MACI, 'MMPI-RF': MMPIRF, TCI, MPQ, EPQ, 'EPQ-R': EPQR, JTCI, JEPQ, 'SCL-90R': SCL90R } as const;
const Data = { MCMI: MCMIData, MACI: MACIData, 'MMPI-RF': MMPIRFData, TCI: TCIData, MPQ: MPQData, EPQ: EPQData, 'EPQ-R': EPQRData, JTCI: JTCIData, JEPQ: JEPQData, 'SCL-90R': SCL90RData } as const;
